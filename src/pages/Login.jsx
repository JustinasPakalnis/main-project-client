      ...
      <section className={style.loginContainer}>
        <section className={style.infoContainer}>
          ...
          <div className={style.note}>
            ...
            <p>
              Daily developing. Feel free to explore, test new features, and
              enjoy my learning journey. Your feedback helps shape what's next.
              Just remember to play nice there!
            </p>
            <address>
        ...
        >
          ...
          <div className={style.loginMessage} data-message={loginMessage}>
            <p>
              If you want to create account, please contact customer support!
            </p>
            <IoCloseSharp
